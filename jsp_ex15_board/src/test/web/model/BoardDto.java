...
public class BoardDto {
	private int num;
	private String author, email, title, content, passwd;
	private Timestamp writeday;
	private int readcnt, repRoot, repStep, repIndent;
	
	public BoardDto() {}

	public BoardDto(int num, String author, String email, String title, String content, String passwd, Timestamp writeday,
